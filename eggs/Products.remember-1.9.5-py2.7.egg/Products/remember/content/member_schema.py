...
plone_schema = atapi.Schema((
    atapi.StringField(
        ...
        widget=atapi.SelectionWidget(
            format='select',
            label='Secretaria',
            label_msgid='label_secretaria',
            description="Selecione a secretaria que voce "
            "trabalha. ",
            description_msgid='help_secretaria',
            i18n_domain='plone')),
     atapi.StringField(
        'coordenadoria',
        mode='rw',
        ...
        widget=atapi.StringWidget(
            label='Coordenadoria',
            label_msgid='label_coordenadoria',
            description="Sua coordenadoria.",
            description_msgid='help_coordenadoria',
            i18n_domain='plone')),
     atapi.StringField(
        'formacao_academica',
        mode='rw',
        ...
        widget=atapi.StringWidget(
            label='Formacao',
            label_msgid='label_formacao',
            description="Digite a sua formacao academica.",
            description_msgid='help_formacao',
            i18n_domain='plone')),
     atapi.StringField(
        'wysiwyg_editor',
        mode='rw',
